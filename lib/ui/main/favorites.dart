...
import 'package:wideal/widget/ilist2.dart';
  ...
  _children() {
    ...
    if (!_selectList) {
      if (appSettings.typeFoods == "type2")
        dishList2(list, userFavorites, context, _onItemClick, windowWidth, "",
            _onAddToCartClick);
      else
        dishList(list, userFavorites, context, _onItemClick, windowWidth,
            _onAddToCartClick, "");
    } else
      dishListOneInLine(list, userFavorites, _onItemClick, windowWidth,
          _onAddToCartClick, "");
