...
class DeliveryDate {
  ...
  changeDeliveryDate(List<Widget> list, double windowWidth,
    ...
    if (dateArrived.isEmpty) _buildDateString(DateTime.now());
    ...
    list.add(Container(
        ...
        child: row2(_time, strings.get(220), () {
          openDialogDate(windowWidth, _redrawD, setBody);
        }) // Change >
        ));
  }
  ...
  openDialogDate(
      double windowWidth, Function(double) _redrawD, Function(Widget) setBody) {
