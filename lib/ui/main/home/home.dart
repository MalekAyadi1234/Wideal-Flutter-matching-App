...
import 'package:wideal/model/server/search.dart';
import 'package:wideal/model/topRestourants.dart';
import 'package:wideal/widget/ReviewsText.dart';
import 'package:wideal/widget/basic/category.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  HomeScreen(
      ...
      required this.onErrorDialogOpen,
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _onAddToCartClick(String id) {
    ...
    if (_addToBasketItem != null) _addToBasketItem!.count = 1;
    setState(() {});
  }
