...
import 'package:wideal/widget/wmap.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(appSettings.defaultLat, appSettings.defaultLng),
    zoom: appSettings.defaultZoom,
  ); // paris coordinates
  Set<Marker> markers = {};
        ...
        child: Stack(children: <Widget>[
          ...
          Align(
            ...
            child: Container(
              ...
              child: skinMapHorizontalRestaurants(windowWidth, context,
  ...
  _map() {
    return GoogleMap(
        ...
        onMapCreated: (GoogleMapController controller) {
          ...
          if (idRestaurantOnMap.isNotEmpty) _navigateToMap();
        });
  }
  ...
  _addMarker(Restaurants item) {
    ...
    if (idRestaurantOnMap == item.id) _lastMarkerId = _lastMarkerId2;
