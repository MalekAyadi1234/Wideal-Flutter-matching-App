...
import 'package:wideal/model/server/notify.dart';
import 'package:wideal/model/server/notifyDelete.dart';
import 'package:wideal/ui/login/needAuth.dart';
import 'package:wideal/widget/ICard29FileCaching.dart';
...
class _NotificationScreenState extends State<NotificationScreen> {
  _dismissItem(String id) {
    ...
    notifyDelete(account.token, id, () {
      ...
      for (var item in _this) if (item.id == id) _delete = item;
  ...
  callbackReload() {
    if (account.isAuth()) getNotify(account.token, _success, _error);
  }
