...
import 'package:wideal/model/server/getRestaurant.dart';
import 'package:wideal/model/server/mainwindowdata.dart';
import 'package:wideal/model/server/reviews.dart';
import 'package:wideal/ui/main/home/home.dart';
import 'package:wideal/ui/main/mainscreen.dart';
import 'package:wideal/widget/buttonadd.dart';
import 'package:wideal/widget/easyDialog2.dart';
import 'package:wideal/widget/ibanner.dart';
import 'package:wideal/widget/iboxCircle.dart';
...
import 'package:wideal/widget/rewiewsBar.dart';
import 'package:wideal/widget/skinRoute.dart';
import 'package:wideal/widget/wproducts.dart';
  ...
  _children() {
    ...
    if (_this != null && _this!.restaurant != null) {
      if (_this!.restaurant!.phone.isNotEmpty ||
        ...
        if (_this!.restaurant!.openTimeMonday.isNotEmpty) if (_this!
    ...
    list.add(Container(
      ...
      child: ListWithIcon(
          ...
          text: "${strings.get(91)} - $_categoryName", // Dishes
          imageColor: theme.colorDefaultText),
    ));
    ...
    if (_this != null) marketReviews(list, _this!, windowWidth);
    list.add(SizedBox(
      height: 20,
    ));
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          Expanded(
              child: Text(
                  "${strings.get(81)}: ${_this!.restaurant!.mobilephone}",
