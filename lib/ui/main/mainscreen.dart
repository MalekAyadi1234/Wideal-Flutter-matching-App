...
import 'package:wideal/model/basket.dart';
import 'package:wideal/model/homescreenModel.dart';
import 'package:wideal/model/notification.dart';
import 'package:wideal/model/pref.dart';
import 'package:wideal/model/server/changePassword.dart';
import 'package:wideal/model/server/changeProfile.dart';
import 'package:wideal/model/server/uploadavatar.dart';
import 'package:wideal/ui/main/account.dart';
import 'package:wideal/ui/main/favorites.dart';
import 'package:wideal/ui/main/home/home.dart';
import 'package:wideal/ui/main/map.dart';
import 'package:wideal/ui/main/orders/orderdetails.dart';
import 'package:wideal/ui/main/orders/orders.dart';
import 'package:wideal/ui/menu/city.dart';
import 'package:wideal/ui/menu/documents.dart';
import 'package:wideal/ui/menu/help.dart';
import 'package:wideal/ui/menu/language.dart';
import 'package:wideal/ui/menu/menu.dart';
import 'package:wideal/ui/menu/wallet.dart';
import 'package:wideal/widget/IBottomBar2.dart';
import 'package:wideal/widget/easyDialog2.dart';
import 'package:wideal/widget/ibottombar.dart';
import 'package:wideal/widget/ibutton3.dart';
import 'package:wideal/widget/skinRoute.dart';
import 'package:wideal/widget/smarter/IBottomBar2Smart.dart';
import 'package:wideal/widget/smarter/ibottombarSmart.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _edit(editControllerName, strings.get(158),
              ...
              if (account.typeReg == "email")
                _edit(editControllerEmail, strings.get(160),
              ...
              if (appSettings.otp != "true")
                _edit(editControllerPhone, strings.get(161),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              _edit(editControllerOldPassword, strings.get(149),
              ...
              _edit(editControllerNewPassword1, strings.get(152),
              ...
              _edit(editControllerNewPassword2, strings.get(154),
                  true), //  "Enter your new password",
              SizedBox(
                height: 30,
              ),
