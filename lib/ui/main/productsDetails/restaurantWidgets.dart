...
import 'package:wideal/widget/iList6.dart';
...
restaurantExtras(List<Widget> list, List<Extras> extras,
    Function(String id, bool value) _extrasClick) {
...
phone(String restaurantPhone, Function() _callMe) {
  if (restaurantPhone.isEmpty) return Container();
  return Container(
    margin: EdgeInsets.only(left: 20, right: 20),
    child: Row(
      children: <Widget>[
        Expanded(
            child: Text("${strings.get(106)}: $restaurantPhone",
                style: theme.text14)),
        IInkWell(
...
phoneMobile(String restaurantMobilePhone, Function() _callMeMobile) {
  if (restaurantMobilePhone.isEmpty) return Container();
  ...
  return Container(
    ...
    child: Row(
      children: <Widget>[
        Expanded(
            child: Text("${strings.get(81)}: $restaurantMobilePhone",
