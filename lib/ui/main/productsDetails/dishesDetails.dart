...
import 'package:wideal/ui/main/productsDetails/humorist.dart';
import 'package:wideal/ui/main/productsDetails/pagin1.dart';
import 'package:wideal/ui/main/productsDetails/rProducts.dart';
import 'package:wideal/ui/main/productsDetails/restaurantWidgets.dart';
import 'package:wideal/ui/main/productsDetails/variants.dart';
import 'package:wideal/widget/cacheImageWidget.dart';
import 'package:wideal/widget/easyDialog2.dart';
import 'package:wideal/widget/ibox.dart';
...
import 'package:wideal/widget/widgets.dart';
...
class _DishesDetailsScreenState extends State<DishesDetailsScreen>
  ...
  _nutrition(List<Widget> list) {
    if (_this.nutritions.isEmpty) return;
    list.add(Container(
      margin: EdgeInsets.only(left: 10, right: 10),
      child: ListWithIcon(
