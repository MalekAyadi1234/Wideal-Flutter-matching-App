...
import 'package:wideal/model/server/login.dart';
import 'package:wideal/model/server/register.dart';
import 'package:wideal/model/social/apple.dart';
import 'package:wideal/model/social/facebook.dart';
import 'package:wideal/model/social/google.dart';
import 'package:wideal/model/utils.dart';
import 'package:wideal/widget/easyDialog2.dart';
import 'package:wideal/widget/iappBar.dart';
import 'package:wideal/widget/ibackground4.dart';
import 'package:wideal/widget/ibutton3.dart';
import 'package:wideal/widget/ibutton4.dart';
import 'package:wideal/widget/iinputField2PasswordA.dart';
import 'package:wideal/widget/iinputField2a.dart';
            ...
            return isAvailableSnapshot.data!
                ? Container(
                    ...
                    child: IButton4(
                        ...
                        textStyle:
                            theme.text14boldWhite, // "Log In with Apple",
      ...
      children: <Widget>[
        ...
        Container(
            ...
            child: IButton3(
                ...
                text: strings.get(22),
                textStyle: theme.text14boldWhite, // LOGIN
                pressButton: () {
                  _pressLoginButton();
                })),
        SizedBox(
        ...
        if (appSettings.googleLogin == "true")
          Container(
              ...
              child: IButton4(
                  ...
                  textStyle: theme.text14boldWhite, // "Log In with Google",
        ...
        if (appSettings.facebookLogin == "true")
          Container(
              ...
              child: IButton4(
                  ...
                  textStyle: theme.text14boldWhite, // Log In with Facebook
