    ...
    child: Container(
      ...
      children: [
        ...
        Container(
          ...
          child: Text(strings.get(125),
              textAlign: TextAlign.center,
              style: theme
                  .text18boldPrimary), // "You must sign-in to access to this section",
        ),
        SizedBox(
          height: 40,
        ),
        Container(
          margin: EdgeInsets.only(
              left: windowWidth * 0.2, right: windowWidth * 0.2),
          child: IButton3(
            pressButton: () {
...
mustAuth(double windowWidth, BuildContext context) {
  if (theme.appSkin == "smarter") return mustAuthSmarter(windowWidth, context);
  return Center(
    child: Container(
        child: Column(
      mainAxisSize: MainAxisSize.min,
