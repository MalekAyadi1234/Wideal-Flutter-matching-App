    ...
    if (Platform.isIOS) {
      return FutureBuilder<bool>(
          ...
          builder: (context, isAvailableSnapshot) {
            if (!isAvailableSnapshot.hasData) return Container();
        ...
        if (appSettings.googleLogin == "true")
          Container(
              ...
              child: IButton4(
                  ...
                  text: strings.get(269),
                  textStyle: theme.text14boldWhite, // Sign In with Google
        ...
        if (appSettings.facebookLogin == "true")
          Container(
              ...
              child: IButton4(
                  ...
                  text: strings.get(270),
                  textStyle: theme.text14boldWhite, // Sign In with Facebook
