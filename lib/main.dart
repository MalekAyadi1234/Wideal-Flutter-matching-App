...
class Appwideal extends StatelessWidget {
  /*
  ...
  Future<void> _initializeFlutterFire() async {
    ...
    Function(FlutterErrorDetails details)? originalOnError =
