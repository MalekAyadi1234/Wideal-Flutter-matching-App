...
import 'package:wideal/animations/letter_spacing.dart';
...
import 'package:wideal/widgets/bottom_sheet_buy.dart';
import 'package:wideal/widgets/button_plain.dart';
import 'package:wideal/widgets/video_player.dart';
                  ...
                  Navigator.of(context).push(
                    PageRouteBuilder(
                      ...
                      pageBuilder: (BuildContext context,
                        ...
                        return DetailPage(
                          image: nftModel.nftImage,
                          video1: nftModel.video,
                          videourl: nftModel.nftVideo,
                          price: nftModel.price,
                          username: nftModel.userName,
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(
                            left: 8.0, right: 0, bottom: 0, top: 8),
                        child: Text(
                          nftModel.nftName,
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(
                                  left: 0.0, right: 0, bottom: 0, top: 8),
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: const BorderRadius.only(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      left: 8.0, right: 8, bottom: 2, top: 4),
                                  child: Column(
                                    children: [
                                      Center(
                                        child: Text(
