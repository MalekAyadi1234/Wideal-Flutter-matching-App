...
class Colorz {
  static const Color timerBlue = Color.fromRGBO(254, 233, 195, 100);

  static const Color backgroundBlue = Color.fromRGBO(254, 233, 195, 100);

  static const Color accountPurple = Color.fromRGBO(254, 233, 195, 100);

  static const Color currenciesPageBackground =
      Color.fromRGBO(254, 233, 195, 100);
  static const Color currenciesNameColor = Color(0xff7080b3);
  static const Color currencyPositiveGreen = Color(0xff4285f4);
  static const Color currencyIndicatorColor = Color(0xff6170f3);

  static const Color sendMoneyBlue = Color(0xff4285f4);

  static const Color googlResultsGrey = Colors.blueGrey;

  // static const Color compexDrawerScaffoldColor = Color(0xfe3e9f7);
  static const Color compexDrawerCanvasColor = Colors.blueGrey;
  static const Color complexDrawerBlack = Color.fromRGBO(254, 233, 195, 100);
  static const Color complexDrawerBlueGrey = Color.fromRGBO(254, 233, 195, 100);
  ...
  //richCalculator
  static const Color richCalculatorCanvas = Color.fromRGBO(254, 233, 195, 100);
  static const Color richCalculatorOutterButtonColor =
      Color.fromRGBO(254, 233, 195, 100);
  static const Color richCalculatorInnerButtonColor =
      Color.fromRGBO(254, 233, 195, 100);
