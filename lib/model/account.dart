...
import 'package:wideal/model/server/favorites.dart';
import 'package:wideal/model/server/fcbToken.dart';
...
class Account {
  ...
  okUserEnter(String name, String password, String avatar, String _email,
    ...
    if (_fcbToken.isNotEmpty) addNotificationToken(account.token, _fcbToken);
  ...
  revertFavoriteState(String id) {
    ...
    if (state) {
      ...
      if (food != null) if (!userFavorites.contains(food))
