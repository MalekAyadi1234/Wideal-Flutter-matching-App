...
class PayMobMainScreenState extends State<PayMobMainScreen> {
  ...
  _getList() {
    ...
    list.add(Container(
        ...
        child: Text(
          "Provide the following information for payment",
  ...
  _next() {
    ...
    if (editControllerState.text.isEmpty) return openDialog("Need enter State");
    if (editControllerCity.text.isEmpty) return openDialog("Need enter City");
    ...
    if (editControllerFloor.text.isEmpty) return openDialog("Need enter Floor");
    ...
    if (editControllerEmail.text.isEmpty) return openDialog("Need enter Email");
    if (editControllerPhone.text.isEmpty) return openDialog("Need enter Phone");
    //
    Navigator.push(
      context,
      MaterialPageRoute(
