...
class FlutterWaveModel {
  ...
  handleCheckout(
      ...
      String userName,
      String orderId,
      Function(String) _onError) async {
    ...
    try {
      Flutterwave flutterwave = Flutterwave.forUIPayment(
          context: context,
          encryptionKey: homeScreen.mainWindowData!.payments
              .flutterWaveEncryptionKey, // "FLWSECK_TESTb2cb67422c66",
          publicKey: homeScreen.mainWindowData!.payments
              .flutterWavePublicKey, //"FLWPUBK_TEST-02351a8bf2d056ea3722151c2aec5f43-X",
          currency: currency,
          amount: amount,
          email: email,
          fullName: userName,
      ...
      if (response.data != null) if (response.status == "success")
