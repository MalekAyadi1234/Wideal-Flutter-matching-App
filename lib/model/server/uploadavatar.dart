...
uploadAvatar(String _avatarFile, String uid, Function(String) callback,
  ...
  try {
    ...
    if (image == null) return callbackError("image decode error");
    ...
    if (ret.ret == "true") {
      var path = "";
      if (ret.filename.isNotEmpty) path = "$serverImages${ret.filename}";
      callback(path);
    } else
