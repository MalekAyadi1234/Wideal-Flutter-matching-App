...
reviewsFoodAdd(
    ...
    String rate,
    String desc,
    Function(String, List<FoodsReviews>) callback,
...
reviewsRestaurantAdd(
    String uid,
    String restaurant,
    String rate,
    String desc,
    Function(String, List<RestaurantsReviewsData>) callback,
    Function(String) callbackError) async {
  try {
    Map<String, String> requestHeaders = {
      'Content-type': 'application/json',
    ...
    String body =
        '{"restaurant": "$restaurant", "rate": "$rate", "desc": "$desc"}';
