...
getWalletBalance(String uid, Function(double) callback,
...
walletTopUp(String uid, String total, String id, Function(double) callback,
    Function(String) callbackError) async {
  try {
    Map<String, String> requestHeaders = {
      'Content-type': 'application/json',
...
payOnWallet(String uid, String total, Function(String) callback,
    Function(String) callbackError) async {
  try {
    Map<String, String> requestHeaders = {
      'Content-type': 'application/json',
...
walletSetId(String uid, String walletId, String orderId, Function() callback,
    Function(String) callbackError) async {
  try {
    Map<String, String> requestHeaders = {
      'Content-type': 'application/json',
