...
import 'package:wideal/animations/siwpe_button.dart';
import 'package:wideal/screens/balance.dart';
import 'package:wideal/utils/colors.dart';
import 'package:wideal/widgets/balance_card.dart';
...
class NftBuyButton extends StatefulWidget {
  String text;
  double price;
  NftBuyButton({Key? key, required this.text, required this.price})
      : super(key: key);
