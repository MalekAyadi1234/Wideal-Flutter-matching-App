...
import 'package:wideal/widget/basic/restaurants.dart';
import 'package:wideal/widget/ilist1.dart';
import 'package:wideal/widget/smarter/ipromotions.dart';
...
sHomeTopRestaurants(List<Widget> list, double windowWidth,
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: appSettings.getIconColorByMode(theme.darkMode),
          ),
          SizedBox(
            width: 10,
          ),
  ...
  list.add(Container(
      ...
      child: IPromotionSmart(
        topRestaurantsWithCity,
        ...
        children: [
          Expanded(
              child: ListWithIcon(
                  ...
                  text: strings.get(39), // Restaurants Near Your
...
sHorizontalTopRestaurants(
    List<Widget> listOutput,
    Function() openFilter,
...
class ICard20FileCachingSmart extends StatefulWidget {
  ...
  @override
  _ICard20FileCachingSmartState createState() =>
      _ICard20FileCachingSmartState();
}
                          ...
                          child: Container(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: cacheImageWidgetCover(
                                      widget.image, theme.colorPrimary))),
                        ))),
                InkWell(
                    onTap: () {
                      if (widget.callback != null)
