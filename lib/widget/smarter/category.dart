...
sSkinHomeCategory(List<Widget> list, double windowWidth,
...
_horizontalCategories(double windowWidth,
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color:
                                      Colors.grey.withAlpha(widget.shadow + 20),
                                  spreadRadius: 2,
                                  blurRadius: 2,
                                  offset: Offset(
...
_horizontalCategoriesCircle(double windowWidth,
    Function(String id, String hero, String image) _onCategoriesClick) {
  List<Widget> list = [];
  list.add(SizedBox(
    width: 10,
