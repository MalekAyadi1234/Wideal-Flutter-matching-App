...
class _ProductsTileListV2State extends State<ProductsTileListV2> {
  ...
  Widget build(BuildContext context) {
    if (theme.appSkin == "smarter") return _smarter();
          ...
          children: <Widget>[
            Container(
                ...
                child: Stack(
                  children: [
                    Icon(
                      (account.getFavoritesState(widget.id))
                          ? Icons.favorite
          ...
          child: Stack(
            children: [
              Hero(
                  ...
                  child: ClipRRect(
                    borderRadius:
                        BorderRadius.all(Radius.circular(appSettings.radius)),
                    child: Container(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                      ...
                      child: ClipRRect(
                          borderRadius: new BorderRadius.only(
                              bottomLeft:
                                  Radius.circular(appSettings.radius - 2),
                              bottomRight:
                                  Radius.circular(appSettings.radius - 2)),
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Text(
                                  widget.text,
                                  style: theme.text18boldPrimaryUIWhite,
              ...
              if (widget.discountprice.isNotEmpty)
                saleSticker(widget.width, widget.discount, widget.discountprice,
                    widget.price)
            ],
          ),
        ));
                      ...
                      Hero(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.all(
                                Radius.circular(appSettings.radius)),
                            child: Container(
                                width: widget.width + 10,
                                height: widget.height,
                                child: cacheImageWidgetCover(
                            ...
                            child: InkWell(
                                ...
                                child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: theme.colorPrimary.withAlpha(220),
                                      border:
                                          Border.all(color: theme.colorPrimary),
                                      borderRadius: new BorderRadius.only(
                                          topLeft: Radius.circular(30)),
                                    ),
                                    child: Container(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(
                              widget.text,
                              style: theme.text18boldPrimaryUI,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.center,
                            ),
                            Text(
                              widget.text3,
                              style: theme.text16UI,
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.center,
                            ),
                            SizedBox(
