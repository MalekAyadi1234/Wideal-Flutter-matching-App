...
class AppThemeData {
  ...
  var colorsVendorGradient = [
    Color(0xff98c7d8).withAlpha(100),
    Color(0xff5794aa),
    Color(0xff306375),
    Color(0xff183843),
  ];
  ...
  init() {
    ...
    if (appSkin == "smarter") colorBackground = Color(0xfffafafa);
  ...
  setAppSettings() {
    ...
    if (user != "true") strings.setLang(lid); // set default language
